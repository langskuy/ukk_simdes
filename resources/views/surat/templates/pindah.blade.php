...
<body>
    ...
    <div style="margin: 0 40px;">
        ...
        <div style="text-align: center; margin-bottom: 15px;">
            <div class="letter-title" style="margin-bottom: 2px;">SURAT KETERANGAN PINDAH / DATANG</div>
            <div
        ...
        <table class="data-table" style="width: 100%;">
            ...
            <tr>
                <td>Jumlah Anggota Pindah</td>
                <td>:</td>
                <td>{{ ($kObj['jumlah_pengikut'] ?? 0) + 1 }} Orang (Termasuk Pemohon)</td>
            </tr>
        </table>

        @if(!empty($kObj['daftar_pengikut']))
            <div class="section-title">II. DAFTAR KELUARGA YANG PINDAH</div>
            <div style="margin-left: 15px; margin-top: 5px; font-size: 11pt; line-height: 1.5; margin-bottom: 15px;">
                {!! nl2br(e($kObj['daftar_pengikut'])) !!}
            </div>
        @endif
        ...
        <div class="letter-body">
            <p>Dengan ini kami menerangkan bahwa pemohon tersebut di atas benar-benar penduduk Desa
                {{ $village['nama_desa'] ?? 'Wonokasian' }}
                yang berencana / telah melakukan perpindahan domisili sesuai dengan data di atas.
            </p>

            <p>Surat keterangan ini diberikan agar dapat dipergunakan sebagai pengantar pengurusan Surat Keterangan
                Pindah
                Warga Negara Indonesia (SKPWNI) atau administrasi kependudukan lainnya di tempat tujuan.</p>
    ...
    <!-- Footer Banner -->
    <div class="footer-banner" style="position: absolute; bottom: 0; left: 0; right: 0; background: #663399;">
        Dokumen Resmi Desa {{ $village['nama_desa'] ?? 'Wonokasian' }} - Surat Keterangan Pindah
    </div>
