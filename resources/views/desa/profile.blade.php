                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3">
                            ...
                            @auth
                                @if(auth()->user()->role === 'admin')
                                    <button class="btn btn-outline-secondary btn-sm mt-1" data-bs-toggle="modal"
                                        data-bs-target="#editDesaModal" title="Edit Profil Desa">
                                        ✏️ Edit Profil
                                    </button>
                                @endif
                            @endauth
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <p class="text-dark fs-5">
                                    <a href="tel:{{ str_replace(['(', ')', ' ', '-'], '', $desa['kontak']['telepon'] ?? '') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <p class="text-dark fs-5">
                                    <a href="mailto:{{ $desa['kontak']['email'] ?? '' }}"
                                        class="text-decoration-none text-dark">
                                        {{ $desa['kontak']['email'] ?? '—' }}
                                    </a>
                                </p>
        ...
        <div class="modal fade" id="editDesaModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.desa.update') }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="populasi" id="populasi" class="form-control" min="0"
                                        value="{{ old('populasi', $pop_num) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="luas_wilayah" class="form-label fw-semibold">Luas Wilayah (km²)</label>
                                    <input type="number" step="0.01" name="luas_wilayah" id="luas_wilayah" class="form-control"
                                        value="{{ old('luas_wilayah', $luas_num) }}">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="jumlah_rt" class="form-label fw-semibold">Jumlah RT</label>
                                    <input type="number" name="jumlah_rt" id="jumlah_rt" class="form-control" min="0"
                                        value="{{ old('jumlah_rt', $rt_num) }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="jumlah_rw" class="form-label fw-semibold">Jumlah RW</label>
                                    <input type="number" name="jumlah_rw" id="jumlah_rw" class="form-control" min="0"
                                        value="{{ old('jumlah_rw', $rw_num) }}">
                                </div>

                                <div class="col-12 mb-3">
                                    <label for="sejarah" class="form-label fw-semibold">Sejarah</label>
                                    <textarea name="sejarah" id="sejarah" rows="4"
                                        class="form-control">{{ old('sejarah', $desa['sejarah']) }}</textarea>
                                </div>

                                <div class="col-12 mb-3">
                                    <label for="visi" class="form-label fw-semibold">Visi</label>
                                    <textarea name="visi" id="visi" rows="2"
                                        class="form-control">{{ old('visi', $desa['visi']) }}</textarea>
                                </div>

                                <div class="col-12 mb-3">
                                    <label for="misi" class="form-label fw-semibold">Misi (satu per baris)</label>
                                    <textarea name="misi" id="misi" rows="4"
                                        class="form-control">{{ old('misi', $misi_text) }}</textarea>
                                </div>

                                <div class="col-12 mb-3">
                                    <label class="form-label fw-semibold">Kontak</label>
                                    <input type="text" name="kontak_alamat" class="form-control mb-2" placeholder="Alamat"
                                        value="{{ old('kontak_alamat', $kontak_alamat) }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" name="kontak_telepon" class="form-control" placeholder="Telepon"
                                                value="{{ old('kontak_telepon', $kontak_telepon) }}">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="email" name="kontak_email" class="form-control" placeholder="Email"
                                                value="{{ old('kontak_email', $kontak_email) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
