...
@section('content')
    ...
    // Calculate financial transparency data
    $pemasukan = \App\Models\Keuangan::where('jenis', 'pemasukan')->sum('nominal');
    $pengeluaran = \App\Models\Keuangan::where('jenis', 'pengeluaran')->sum('nominal');
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-6 text-lg-end">
                        <div class="d-flex gap-2 flex-wrap justify-content-lg-end mt-3 mt-lg-0">
                            <a href="{{ route('profile') }}" class="btn btn-warning fw-bold px-4 text-dark">
        ...
        <div class="container py-5">
            <div class="row g-3 mb-5">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="card border-0 rounded-4 shadow-sm overflow-hidden h-100 stat-card"
            ...
            <div class="row g-4 mb-5">
                <div class="col-12">
                    <div class="card border-0 rounded-4 shadow-sm h-100">
                        <div class="card-header border-0 bg-white rounded-4 p-4 pb-0">
                            <div class="d-flex align-items-center mb-2">
                                <div class="bg-success bg-opacity-10 rounded-3 p-3 me-3">
                                    <i class="bi bi-wallet2 text-success fs-5"></i>
                                </div>
                                <div>
                                    <h5 class="card-title fw-bold mb-0">Transparansi Anggaran Desa</h5>
                                    <small class="text-muted">Ringkasan keuangan desa tahun ini</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-4">
                                    <div class="p-3 rounded-4 bg-success bg-opacity-10">
                                        ...
                                        <h4 class="fw-bold text-dark mb-0">Rp {{ number_format($pemasukan, 0, ',', '.') }}
                                        </h4>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="p-3 rounded-4 bg-danger bg-opacity-10">
                                        ...
                                        <h4 class="fw-bold text-dark mb-0">Rp {{ number_format($pengeluaran, 0, ',', '.') }}
                                        </h4>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4">
                                    <div class="p-3 rounded-4 bg-primary bg-opacity-10">
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <span class="text-primary fw-bold small text-uppercase">Sisa Saldo</span>
                                        </div>
                                        <h4 class="fw-bold text-dark mb-0">Rp {{ number_format($saldo, 0, ',', '.') }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-3 mb-5">
                <div class="col-12">
                    <div class="card border-0 rounded-4 shadow-sm bg-light">
                        <div class="card-body p-4">
                            <h5 class="text-dark mb-4 fw-bold">⚡ Layanan Cepat</h5>
                            <div class="row g-2">
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <a href="{{ route('surat.create') }}"
                                        class="btn btn-primary w-100 rounded-3 fw-bold py-3">
                                        <i class="bi bi-plus-circle me-2"></i>Ajukan Surat Baru
                                    </a>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <a href="{{ route('surat.history') }}"
                                        class="btn btn-outline-primary w-100 rounded-3 fw-bold py-3">
                                        <i class="bi bi-clock-history me-2"></i>Riwayat Pengajuan
                                    </a>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <a href="{{ route('pengaduan.create') }}"
                                        class="btn btn-danger w-100 rounded-3 fw-bold py-3">
                                        <i class="bi bi-exclamation-octagon me-2"></i>Ajukan Pengaduan
                                    </a>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <a href="{{ route('pengaduan.history') }}"
                                        class="btn btn-outline-danger w-100 rounded-3 fw-bold py-3">
                                            ...
                                            @foreach($surats as $surat)
                                                <tr class="align-middle">
                                                    <td>
                                                        ...
                                                        @if($surat->keterangan)
                                                            <small
                                                                class="text-muted d-block">{{ Str::limit($surat->keterangan, 40) }}</small>
                                                        @endif
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="list-group-item border-bottom-light py-3 px-0">
                                            <div class="d-flex gap-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1 fw-semibold"><a href="{{ route('kegiatan.show', $item) }}"
                                                            class="text-reset">{{ Str::limit($item->judul, 30) }}</a></h6>
                                                    <small class="text-muted d-block">📅
                                                        {{ $item->tanggal ? $item->tanggal->format('d M Y') : '—' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <div class="row g-4 mb-5">
                <div class="col-12 col-lg-6">
                    <div class="card border-0 rounded-4 shadow-sm bg-gradient-info text-white"
                        style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                        <div class="card-body p-4">
                            ...
                            <p class="text-white-50 small mb-0">Pengajuan surat desa akan diproses sesuai antrian dan
                                biasanya selesai dalam 1-3 hari kerja.</p>
                        </div>
                    </div>
                </div>

                <div class="col-12 col-lg-6">
                    <div class="card border-0 rounded-4 shadow-sm bg-gradient-danger text-white"
                        style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start gap-3 mb-3">
                                <div class="bg-white bg-opacity-20 rounded-3 p-3">
                            ...
                            <p class="text-white-50 small mb-0">Untuk pertanyaan atau keperluan darurat, hubungi customer
                                service kami.</p>
                        </div>
                    </div>
                </div>
