                            ...
                            @foreach ($pengaduans as $pengaduan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.pengaduan.show', $pengaduan) }}" class="btn btn-sm btn-info" title="Lihat Detail">👁️</a>
                                        <a href="{{ route('admin.pengaduan.edit', $pengaduan) }}" class="btn btn-sm btn-primary" title="Edit">✏️</a>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $pengaduan->id }}" title="Hapus">🗑️</button>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="text-danger fw-semibold">⚠️ Anda yakin ingin menghapus pengaduan ini?</p>
                                                <p>Pengaduan <strong>{{ $pengaduan->judul }}</strong> dari <strong>{{ $pengaduan->nama_pelapor }}</strong> akan dihapus secara permanen dan tidak bisa dikembalikan.</p>
                                            </div>
