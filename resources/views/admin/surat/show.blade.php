            ...
            <div class="col-md-8 offset-md-2">
                <div class="card shadow border-0 rounded-3">
                    ...
                    <div class="card-body">
                        ...
                        @if ($surat->lampiran)
                            <div class="mb-4">
                                <p class="text-muted mb-1 fw-bold">📎 Lampiran Dokumen (Persyaratan)</p>
                                <div class="row g-2">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-warning fw-semibold" data-bs-toggle="modal"
                                data-bs-target="#updateStatusModal">⚙️ Update Status</button>
                            <button type="button" class="btn btn-primary fw-semibold" data-bs-toggle="modal"
                                data-bs-target="#uploadFileModal">📤 Upload File Surat</button>
                            <button type="button" class="btn btn-success fw-semibold" data-bs-toggle="modal"
                                data-bs-target="#generatePdfModal">🔄 Generate PDF Otomatis</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.surat.update', $surat) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                    <div class="modal-body">
                        <label for="file_surat" class="form-label fw-semibold">Pilih File Surat (PDF/Gambar)</label>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.surat.update', $surat) }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="alert alert-info mb-0"><small>PDF akan dibuat dari template surat dengan data pemohon dan
                                keterangan. File otomatis tersimpan dan bisa langsung didownload oleh warga.</small></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" name="generate_pdf" value="1" class="btn btn-success fw-semibold">Generate
                            PDF</button>
                    </div>
                </form>
            </div>
