        ...
        <div class="col-lg-6">
            <div class="card border-0 rounded-4 shadow-sm">
                <div class="card-header bg-transparent border-0 p-4">
                    <h5 class="fw-bold mb-0"><i class="bi bi-pencil-square me-2 text-primary"></i>Edit Transaksi</h5>
                </div>
                    ...
                    <form action="{{ route('admin.keuangan.update', $keuangan) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kategori" class="form-control rounded-3"
                                value="{{ old('kategori', $keuangan->kategori) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="nominal" class="form-control rounded-3"
                                value="{{ old('nominal', $keuangan->nominal) }}" required min="0">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="keterangan" class="form-control rounded-3"
                                rows="3">{{ old('keterangan', $keuangan->keterangan) }}</textarea>
