...
<div class="container py-5">
    ...
    <div class="mb-6 border-b">
        <div class="flex gap-4">
            ...
            <a href="{{ route('gallery.kegiatan') }}" class="pb-3 px-2 border-b-2 border-blue-500 text-blue-600 font-semibold">
                Kegiatan
            </a>
        </div>
    </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden group">
                    ...
                    <div class="h-56 overflow-hidden bg-gray-200">
                        @if($kegiatan->foto && file_exists(public_path($kegiatan->foto)))
                            <img src="{{ asset($kegiatan->foto) }}" alt="{{ $kegiatan->judul }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-300">
                        @else
                    ...
                    <div class="p-5">
                        ...
                        <!-- Button -->
                        <a href="{{ route('gallery.kegiatan.show', $kegiatan->id) }}" class="block text-center w-full bg-green-600 text-white py-2 rounded font-semibold hover:bg-green-700 transition">
                            Lihat Detail
                        </a>
                    </div>
                </div>
