    ...
    <div class="container py-5">
        ...
        <div class="mb-5 flex justify-between items-center">
            ...
            <a href="{{ route('beranda') }}"
                class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg transition border border-gray-300 flex items-center gap-2">
                        ...
                        <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('gallery.pengaduan.show', $pengaduan->id) }}"
                                    class="block text-center bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition text-sm font-semibold">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('gallery.kegiatan.show', $kegiatan->id) }}"
                                    class="block text-center bg-green-600 text-white py-2 rounded hover:bg-green-700 transition text-sm font-semibold">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
